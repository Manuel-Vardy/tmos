...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Trite Merchant OS" },
      {
        name: "description",
        content:
          "The merchant operating system for African businesses: inventory, branches, invoicing and payments in one dashboard.",
      },
      { name: "author", content: "Trite" },
      { property: "og:title", content: "Trite Merchant OS" },
      {
        property: "og:description",
        content: "Sell, stock, invoice, reconcile and get paid — one branch or fifty.",
      },
